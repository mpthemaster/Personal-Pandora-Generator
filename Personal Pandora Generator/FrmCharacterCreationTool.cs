    ...
    public partial class FrmCharacterCreationTool : Form
    {
        ...
        private void generateBtn_Click(object sender, EventArgs e)
        {
            ...
            Redo:
                ...
                if (radLikes.Checked)
                    lblResultPossibilities.Text += likes[gen] + ". ";
                else if (radPersonality.Checked)
                    lblResultPossibilities.Text += traits[gen] + ". ";
                else if (radSkills.Checked)
                    lblResultPossibilities.Text += skills[gen] + ". ";
                else if (radMottos.Checked)
                {
                    i = (int) numAmountGenerated.Value;
                    lblResultPossibilities.Text = mottos[gen];
                }
                else
        ...
        {
            int lower = int.Parse(txtLowerAgeRange.Text);
            int higher = int.Parse(txtHigherAgeRange.Text);
            ...
            if (lower >= higher)
            {
                ...
                txtAgeResult.Text = rnd.Next(lower, higher + 1).ToString();
        }
